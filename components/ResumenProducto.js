...
const ResumenProducto = ({ producto }) => {
  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div>
        <button
          className="bg-sky-600 flex gap-1 px-5 py-2 text-white rounded font-bold text-center shadow-md"
          type="button"
        ...
        <button
          className="bg-red-600 flex gap-1 px-5 py-2 text-white rounded font-bold mt-3 text-center shadow-md"
          type="button"
